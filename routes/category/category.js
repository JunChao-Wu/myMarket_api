...
/* 添加 分类 */
router.post(ApiConstants.API.category.addCategory.url, async (req, res) => {
  let obj = req.body;
...
/* 删除 分类 */
router.post(ApiConstants.API.category.deleteCategory.url, async (req, res) => {
  let obj = req.body;
  // console.log(obj)
...
/* 获取 分类 */
router.post(ApiConstants.API.category.getCategory.url, async (req, res) => {
  let categoryDao = new CategoryDao(pool);
